 ...
 * solutions.
 */
public class SOACrossover2 extends Crossover {
  /**
   ...
   */
  public SOACrossover2(HashMap<String, Object> parameters) {
  	super(parameters) ;
  ...
  public Solution[] doCrossover(double probability,
	  ...
	  corssoverPoint_= (Math.abs(PseudoRandom.randInt()%parent1.getCompositionService().size()))+1;  
