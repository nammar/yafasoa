 ...
 */
public class Solution_BU implements Serializable {  
	/**
	 * Stores the problem 
	 */
   ...
   */
  public Solution_BU(int numberOfObjectives) {
   ...
   */
  public Solution_BU(Problem problem) throws ClassNotFoundException{
    problem_ = problem ; 
  ...
  static public Solution_BU getNewSolution(Problem problem) throws ClassNotFoundException {
    return new Solution_BU(problem) ;
  }
   ...
   * @param problem The problem to solve
   */
  public Solution_BU(Problem problem, Variable [] variables){
    problem_ = problem ;
  	type_ = problem.getSolutionType() ;
    numberOfObjectives_ = problem.getNumberOfObjectives() ;
    objective_          = new double[numberOfObjectives_] ;
   ...
   */    
  public Solution_BU(Solution_BU solution) {            
