 ...
 */
public class SmartCitySolution extends Solution implements Serializable {  
	/**
	 * Stores the problem 
	 */
   ...
   */
  public SmartCitySolution(int numberOfObjectives) {
   ...
   */
  public SmartCitySolution(Problem problem) throws ClassNotFoundException{
    problem_ = problem ; 
  ...
  static public SmartCitySolution getNewSolution(Problem problem) throws ClassNotFoundException {
    return new SmartCitySolution(problem) ;
  }
   ...
   * @param problem The problem to solve
   */
  public SmartCitySolution(Problem problem, Variable [] variables){
    problem_ = problem ;
  	type_ = problem.getSolutionType() ;
    numberOfObjectives_ = problem.getNumberOfObjectives() ;
    objective_          = new double[numberOfObjectives_] ;
   ...
   */    
  public SmartCitySolution(SmartCitySolution solution) {            
 ...
 //   variable_ = type_.copyVariables(solution.variable_) ;
  ...
  public void setGenome(ArrayList<Gene> V_SericeComposition){
	 this.genes=V_SericeComposition;
