...
public class Solution implements Serializable {  
  ...
  ArrayList<Service> ServiceComposition=new ArrayList<Service>();
  ...
  public Solution(Solution solution) {            
    ...
    for (int i = 0; i < objective_.length;i++) {
      ...
      ServiceComposition=solution.getCompositionService();// added by wafaa 9-2-2016
 ...
 //   variable_ = type_.copyVariables(solution.variable_) ;
  ...
  public ArrayList<Service> getCompositionService(){
	return this.ServiceComposition;
	  
  }
  /* jsdjdsjsksdljslkjsljdsljslkdjsldj add wafaa 21-2*/
  public double size(ArrayList<Service> S){
	  return S.size();
  }
  
  public void setCompositionService(ArrayList<Service> V_SericeComposition){
	 this.ServiceComposition=V_SericeComposition;
